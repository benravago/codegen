...
abstract class Instruction {
  ...
  public Code _iload                   (Object v) { return i_1v           ( OP_iload, v              ); } // 15  (1)  lv.index
  public Code _lload                   (Object v) { return i_1v           ( OP_lload, v              ); } // 16  (1)  lv.index
  public Code _fload                   (Object v) { return i_1v           ( OP_fload, v              ); } // 17  (1)  lv.index
  public Code _dload                   (Object v) { return i_1v           ( OP_dload, v              ); } // 18  (1)  lv.index
  public Code _aload                   (Object v) { return i_1v           ( OP_aload, v              ); } // 19  (1)  lv.index
  ...
  public Code _istore                  (Object v) { return i_1v           ( OP_istore, v             ); } // 36  (1)  lv.index
  public Code _lstore                  (Object v) { return i_1v           ( OP_lstore, v             ); } // 37  (1)  lv.index
  public Code _fstore                  (Object v) { return i_1v           ( OP_fstore, v             ); } // 38  (1)  lv.index
  public Code _dstore                  (Object v) { return i_1v           ( OP_dstore, v             ); } // 39  (1)  lv.index
  public Code _astore                  (Object v) { return i_1v           ( OP_astore, v             ); } // 3a  (1)  lv.index
  ...
  public Code _ifeq                    (Object j) { return i_2j           ( OP_ifeq, j               ); } // 99  (2)  branch
  public Code _ifne                    (Object j) { return i_2j           ( OP_ifne, j               ); } // 9a  (2)  branch
  public Code _iflt                    (Object j) { return i_2j           ( OP_iflt, j               ); } // 9b  (2)  branch
  public Code _ifge                    (Object j) { return i_2j           ( OP_ifge, j               ); } // 9c  (2)  branch
  public Code _ifgt                    (Object j) { return i_2j           ( OP_ifgt, j               ); } // 9d  (2)  branch
  public Code _ifle                    (Object j) { return i_2j           ( OP_ifle, j               ); } // 9e  (2)  branch
  public Code _if_icmpeq               (Object j) { return i_2j           ( OP_if_icmpeq, j          ); } // 9f  (2)  branch
  public Code _if_icmpne               (Object j) { return i_2j           ( OP_if_icmpne, j          ); } // a0  (2)  branch
  public Code _if_icmplt               (Object j) { return i_2j           ( OP_if_icmplt, j          ); } // a1  (2)  branch
  public Code _if_icmpge               (Object j) { return i_2j           ( OP_if_icmpge, j          ); } // a2  (2)  branch
  public Code _if_icmpgt               (Object j) { return i_2j           ( OP_if_icmpgt, j          ); } // a3  (2)  branch
  public Code _if_icmple               (Object j) { return i_2j           ( OP_if_icmple, j          ); } // a4  (2)  branch
  public Code _if_acmpeq               (Object j) { return i_2j           ( OP_if_acmpeq, j          ); } // a5  (2)  branch
  public Code _if_acmpne               (Object j) { return i_2j           ( OP_if_acmpne, j          ); } // a6  (2)  branch
  public Code _goto                    (Object j) { return i_2j           ( OP_goto, j               ); } // a7  (2)  branch
  public Code _jsr                     (Object j) { return i_2j           ( OP_jsr, j                ); } // a8  (2)  branch
  public Code _ret                     (Object c) { return i_1c           ( OP_ret, c                ); } // a9  (1)  cp.index
  public Code _tableswitch           (Object...a) { return i_p_4d_4d_4d_v ( OP_tableswitch, a        ); } // aa  (0-3,4,4,4,...) padding, default, low, high, jump offsets
  public Code _lookupswitch          (Object...a) { return i_p_4d_4d_v    ( OP_lookupswitch, a       ); } // ab  (0-3,4,4,...)  padding, default, npairs, match/offset pairs
  ...
  public Code _invokeinterface (Object c, byte d) { return i_2c_1d_0      ( OP_invokeinterface, c, d ); } // b9  (2,1,0)  cp.index, count, 0
  ...
  public Code _wide          (byte w, Object...a) { return i_1w_2c_v      ( OP_wide, w, a            ); } // c4  (1,2 | 1,2,2)  opcode, cp.index | iinc, cp.index, count
  public Code _multianewarray  (Object c, byte d) { return i_2c_1d        ( OP_multianewarray, c, d  ); } // c5  (2,1)  cp.index, dimensions
  public Code _ifnull                  (Object j) { return i_2j           ( OP_ifnull, j             ); } // c6  (2)  branch
  public Code _ifnonnull               (Object j) { return i_2j           ( OP_ifnonnull, j          ); } // c7  (2)  branch
  public Code _goto_w                  (Object j) { return i_4j           ( OP_goto_w, j             ); } // c8  (4)  branch
  public Code _jsr_w                   (Object j) { return i_4j           ( OP_jsr_w, j              ); } // c9  (4)  branch
