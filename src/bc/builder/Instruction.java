...
abstract class Instruction {
  ...
  public Code _ldc                     (Object...c) { return i_1c           ( OP_ldc &L, c                ); } // 12  (1)  cp.index
  public Code _ldc_w                   (Object...c) { return i_2c           ( OP_ldc_w &L, c              ); } // 13  (2)  cp.index
  public Code _ldc2_w                  (Object...c) { return i_2c           ( OP_ldc2_w &L, c             ); } // 14  (2)  cp.index
  ...
  public Code _getstatic               (Object...c) { return i_2c           ( OP_getstatic &F, c          ); } // b2  (2)  cp.index
  public Code _putstatic               (Object...c) { return i_2c           ( OP_putstatic &F, c          ); } // b3  (2)  cp.index
  public Code _getfield                (Object...c) { return i_2c           ( OP_getfield &F, c           ); } // b4  (2)  cp.index
  public Code _putfield                (Object...c) { return i_2c           ( OP_putfield &F, c           ); } // b5  (2)  cp.index
  public Code _invokevirtual           (Object...c) { return i_2c           ( OP_invokevirtual &M, c      ); } // b6  (2)  cp.index
  public Code _invokespecial           (Object...c) { return i_2c           ( OP_invokespecial &M, c      ); } // b7  (2)  cp.index
  public Code _invokestatic            (Object...c) { return i_2c           ( OP_invokestatic &M, c       ); } // b8  (2)  cp.index
  public Code _invokeinterface (byte d, Object...c) { return i_2c_1d_0      ( OP_invokeinterface &M, d, c ); } // b9  (2,1,0)  cp.index, count, 0
  public Code _invokedynamic           (Object...c) { return i_2c_0_0       ( OP_invokedynamic &M, c      ); } // ba  (2,0,0)  cp.index, 0, 0
  public Code _new                     (Object...c) { return i_2c           ( OP_new &T, c                ); } // bb  (2)  cp.index
  public Code _newarray                    (byte t) { return i_1t           ( OP_newarray, t              ); } // bc  (1)  atype
  public Code _anewarray               (Object...c) { return i_2c           ( OP_anewarray &T, c          ); } // bd  (2)  cp.index
  public Code _arraylength                       () { return i_             ( OP_arraylength              ); } // be
  public Code _athrow                            () { return i_             ( OP_athrow                   ); } // bf
  public Code _checkcast               (Object...c) { return i_2c           ( OP_checkcast &T, c          ); } // c0  (2)  cp.index
  public Code _instanceof              (Object...c) { return i_2c           ( OP_instanceof &T, c         ); } // c1  (2)  cp.index
  ...
  public Code _multianewarray  (byte d, Object...c) { return i_2c_1d        ( OP_multianewarray &T, d, c  ); } // c5  (2,1)  cp.index, dimensions
  ...
  abstract Code i_1c           (int o, Object...c);         //  (1)  cp.index
  abstract Code i_2c           (int o, Object...c);         //  (2)  cp.index
  abstract Code i_2c_1d        (int o, byte d, Object...c); //  (2,1)  cp.index, const
  ...
  abstract Code i_2c_1d_0      (int o, byte d, Object...c); //  (2,1,0)  cp.index, count, 0
  abstract Code i_2c_0_0       (int o, Object...c);         //  (2,0,0)  cp.index, 0, 0
  ...
  static final int
    ref_mask  = 0xff00,        // REF bits
    op_mask   = 0x00ff;        // OP bits

  static final int             // constant pool item should be:
    Loadable  = 0x0100,        //   'loadable' # JVMS Table 4.4-C. Loadable constant pool tags
    FieldRef  = 0x0200,        //   a Field reference
    MethodRef = 0x0400,        //   a Method reference
    TypeRef   = 0x0800;        //   a Type (class, array, or interface)
