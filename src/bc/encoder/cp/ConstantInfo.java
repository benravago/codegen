...
class ConstantInfo extends Pool {
  ...
  //   u4 low_bytes;
  // }
  short Long(long value) { return t64(CONSTANT_Long, value); }
  ...
  short Class(String s) { return t16(CONSTANT_Class, Utf8(s)); }

  //  8 CONSTANT_String_info { u1 tag; u2 string_index; }
  short String(String s) { return t16(CONSTANT_String, Utf8(s)); }
  ...
  // }
  short Field(String c, String n, String d) {
  ...
  //   u2 name_and_type_index;
  // }
  short Method(String c, String n, String d) {
  ...
  //   u2 name_and_type_index;
  // }
  short InterfaceMethod(String c, String n, String d) {
  ...
  //   u2 descriptor_index;
  // }
  short NameAndType(String name, String descriptor) {
  ...
  //   u2 reference_index;
  // }
  short MethodHandle(byte kind, short index) {
  ...
  //   u2 name_and_type_index;
  // }
  short Dynamic(short index, String n, String d) {
  ...
  //   u2 name_and_type_index;
  // }
  short InvokeDynamic(short index, String n, String d) {
