...
abstract class Instruction {
  ...
  public Code tableswitch  (int d, int l, int h, int...j) { return i_p_4d_4l_4h_x ( OP_tableswitch, d,h,l,j  ); } // aa  (0-3,4,4,4,...) padding, default, low, high, jump offsets
  public Code lookupswitch        (int d, int n, int...m) { return i_p_4d_4n_x    ( OP_lookupswitch, d, n, m ); } // ab  (0-3,4,4,...)  padding, default, npairs, match/offset pairs
