...
class Operation implements Formattable {
  ...
  void i_        () { f( "%s"            , n()                   ); } //  -
  void i_1b      () { f( "%s  %d"        , n(), u1()             ); } //  (1)  byte
  void i_2s      () { f( "%s  %d"        , n(), u2()             ); } //  (2)  short
  void i_1c      () { f( "%s  %s"        , n(), cp(u1())         ); } //  (1)  cp.index
  void i_2c      () { f( "%s  %s"        , n(), cp(u2())         ); } //  (2)  cp.index
  void i_2c_1d   () { f( "%s  %s, %d"    , n(), cp(u2(0)), u1(1) ); } //  (2,1)  cp.index, const
  void i_1v      () { f( "%s  %s"        , n(), lv(u1())         ); } //  (1)  lv.index
  void i_1v_1d   () { f( "%s  %s, %d"    , n(), lv(u1(0)), u1(1) ); } //  (1,1)  lv.index, const
  void i_1t      () { f( "%s  =%d"       , n(), u1()             ); } //  (1)  atype
  void i_2j      () { f( "%s  >%04x"     , n(), jp(u2())         ); } //  (2)  branch
  void i_4j      () { f( "%s  >%08x"     , n(), jp(u4())         ); } //  (4)  branch
  void i_2c_1d_0 () { f( "%s  %s, %d, 0" , n(), cp(u2(0)), u1(1) ); } //  (2,1,0)  cp.index, count, 0
  void i_2c_0_0  () { f( "%s  %s, 0, 0"  , n(), cp(u2(0))        ); } //  (2,0,0)  cp.index, 0, 0

  void i_p_4d_4d_4d_x() {
    var v = (Integer[])o.args();
    f("%04x  %s  %d,", o.pc(), n(), v[0] ); // pc, op, padding
    for (int i = 1, m = v.length; i < m;) {
      f( " 0x%08x%c", v[i++], i < m ? ',' : ' '); // default, low, high, jump offsets
    }
  }
  ...
  void i_p_4d_4d_x() {
    ...
    for (int i = 3, m = v.length; i < m;) {
      f( " 0x%08x, 0x%08x%c,", v[i++], v[i++], i < m ? ',' : ' ' ); // match/offset pairs
    }
  }
